...
function rsvpArc(value: number, offset: number, total: number) {
...
export function MarketingView({ guests }: { guests: GuestDto[] }) {
  ...
  const pendingOffset = (confirmed / safeTotal) * CIRCUMFERENCE
  const declinedOffset = pendingOffset + (pending / safeTotal) * CIRCUMFERENCE
      ...
      <section id="features" className="mx-auto max-w-7xl px-5 sm:px-8 py-20">
        <div className="text-center mb-12">
          ...
          <p className="mt-3 text-muted-foreground max-w-xl mx-auto">
            Desde el primer &quot;sí&quot; hasta el último vals. Nuptia reúne todo lo que necesitáis en un único lugar.
          </p>
        </div>
                  ...
                  <div className="relative shrink-0">
                    <svg width="96" height="96" viewBox="0 0 96 96" className="-rotate-90">
                      ...
                      <circle
                        ...
                        style={rsvpArc(confirmed, confirmedOffset, safeTotal)}
                      />
                      <circle
                        cx="48" cy="48" r="38" fill="none"
                        stroke="var(--color-accent)"
                        strokeWidth="10" strokeLinecap="round"
                        style={rsvpArc(pending, pendingOffset, safeTotal)}
                      />
                      <circle
                        cx="48" cy="48" r="38" fill="none"
                        stroke="var(--color-destructive)"
                        strokeWidth="10" strokeLinecap="round"
                        style={rsvpArc(declined, declinedOffset, safeTotal)}
                      />
                    </svg>
            ...
            <div className="rounded-2xl border border-border bg-card p-5 shadow-sm flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-baseline gap-2">
                  <span className="font-serif text-3xl text-foreground">{Math.round((confirmed / safeTotal) * 100)}%</span>
                  <span className="text-xs text-muted-foreground">confirmados</span>
                </div>
                <div className="h-2 rounded-full bg-secondary overflow-hidden">
                  <div
                    className="h-full rounded-full bg-primary transition-all"
                    style={{ width: `${(confirmed / safeTotal) * 100}%` }}
                  />
                </div>
      ...
      <section className="relative overflow-hidden py-24">
        ...
        <div className="relative z-10 mx-auto max-w-2xl px-5 text-center flex flex-col items-center gap-6">
          ...
          <p className="text-primary-foreground/70 text-lg max-w-md leading-relaxed">
            Cread vuestra boda en Nuptia hoy. Sin suscripciones complicadas, sin comisiones ocultas.
          </p>
          <Link
            href="/app"
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-8 py-12">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
            ...
            <div className="sm:col-span-2 lg:col-span-1 flex flex-col gap-3">
              <div className="flex items-center gap-2">
                ...
                <span className="font-serif text-lg">Nuptia</span>
              </div>
            ...
            {[
              ...
              {
                title: "Empresa",
                links: ["Sobre Nuptia", "Blog", "Prensa", "Contacto"],
              },
              {
                title: "Legal",
          ...
          <div className="border-t border-primary-foreground/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
            <p className="text-xs text-primary-foreground/40">
              © 2026 Nuptia · Estudio de Bodas Digital. Todos los derechos reservados.
            </p>
