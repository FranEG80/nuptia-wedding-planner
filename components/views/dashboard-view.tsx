...
import { WEDDING, GUESTS } from "@/lib/wedding-data"
      ...
      <section className="relative overflow-hidden rounded-3xl border border-border shadow-sm">
        ...
        <div className="absolute inset-0 flex flex-col justify-center gap-3 p-8 text-primary-foreground sm:p-12">
          ...
          <h1 className="max-w-lg text-balance font-serif text-3xl leading-tight sm:text-4xl">
            ¡Bienvenidos, {WEDDING.brideName} y {WEDDING.groomName}!
          </h1>
          <p className="max-w-md text-sm text-primary-foreground/80">
            Vuestra historia se celebra en {WEDDING.venueCity}. Aquí tenéis todo
      ...
      <section className="grid gap-5 md:grid-cols-3">
        ...
        <div className="rounded-2xl border border-border bg-card p-6 shadow-sm">
          ...
          <div className="mt-4 space-y-2">
            {[
              { id: "invitation" as ViewId, label: "Editar invitación", icon: Mail },
              { id: "website" as ViewId, label: "Configurar web", icon: Globe },
              { id: "guests" as ViewId, label: "Gestionar invitados", icon: Users },
            ].map((s) => {
              const Icon = s.icon
              return (
                <button
